	...
	public function getPatientPrescInfoByCode(){
        ...
        if($client_token->jti==$server_token ){
			...
			$json_response = [
					 ...
					 "diseaseInfo" => $this->disease->getDiseaseBySymptomsIds($resultdata->diagonised_list , $hospital_id),
					 "medicineInfo" => $this->medicine->getLastPrescMedicines($resultdata->prescription_addmission_id , "O" ,$hospital_id,$resultdata->patient_health_profile_id),
					 "reportsInfo" => $this->investigation->getLastPrescTestReports($resultdata->prescription_addmission_id , "O",  $hospital_id,$resultdata->patient_health_profile_id),
					/* "referalHospital" */
            ];
